...
## A note about AI
AI was used in the development of this project, primarily for writing out the HTML components, the security rules, the above portions of the ReadMe, and the initial structure of the extension. I have reviewed and edited all AI-generated code to ensure it meets the project requirements and functions correctly. The AI was a helpful tool for quickly generating boilerplate code and structuring the extension, but all final code has been vetted and tested by me. I took the time to research VS Code extension development myself, as well as common web security vulnerabilities that I could easily test for with regex. I specifically used Claude. 